...
It's a **flipbook**: turn the pages by swiping left/right, tapping the ‹ › buttons, or
using the arrow keys. Full-screen and phone-first, inspired by madeforanita.
...
Built with React + Vite + Framer Motion (custom CSS 3D page-flip).
